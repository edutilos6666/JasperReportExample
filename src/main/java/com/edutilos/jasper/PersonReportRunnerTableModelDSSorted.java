...
public class PersonReportRunnerTableModelDSSorted {
    ...
    private static JasperPrint generateJasperPrint() {
        try {
            final ClassLoader classLoader = PersonReportRunnerTableModelDSSorted.class.getClassLoader();
            String srcFileName = classLoader.getResource("jasper/PersonSorted.jrxml").getFile();
    ...
    private static TableModel getBeans() {
        ...
        ret.addRow(new Object[]{2L, "bar", 30, 200.0, false});
