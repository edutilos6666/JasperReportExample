...
public class PersonWithSummaryReportRunner {
    ...
    private static JasperPrint generateJasperPrint() {
        try {
            String srcFileName = PersonWithSummaryReportRunner.class.getClassLoader().getResource("jasper/PersonWithSummary.jrxml").getFile();
